...
email status until they click the link in the confirmation email.`
    ...
    organization: {
      type: 'string',
      required: false,
      description: 'The sid of the user\'s brokerage.'
    },
    ...
    title: {
      type: 'string',
      required: false,
      description: 'The user\'s business title.',
      example: 'REALTOR'
    },
    ...
    brokerage: {
      type: 'string',
      required: false,
      description: 'The user\'s brokerage name.',
      example: 'Acme Realty'
    },
    ...
    defaultBrokerAdmin: {
      type: 'number',
      required: false,
      description: 'The user\'s default administration fee',
      example: 450
    },

    isSuperAdmin: {
      type: 'boolean',
      description: 'Whether this user is an application administrator.',
      extendedDescription: ''
    },

    isOrgAdmin: {
      type: 'boolean',
      description: 'Whether this user is an administrator for their organization.',
      extendedDescription: ''
    },
...
without necessarily having a billing card.`
    ...
    organization: { model: 'Organization', description: 'This user\'s organization.' },
